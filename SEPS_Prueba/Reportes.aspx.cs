...
using SEPS.ReportesTableAdapters;
using System.Linq;
...
namespace ASSMCA.Reportes
{
	...
	{
		public VW_REPORTESTableAdapter VW_REPORTES = new VW_REPORTESTableAdapter();
		public VW_CATEGORIA_REPORTETableAdapter VW_CATEGORIA_REPORTES = new VW_CATEGORIA_REPORTETableAdapter();
