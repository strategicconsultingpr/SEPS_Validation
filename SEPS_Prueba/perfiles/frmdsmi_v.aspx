...
<html lang="en">
 <head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="<%= Page.ResolveClientUrl("~/vendor/jquery-1.11.2.min.js?ver=2") %>"></script>
    <script type='text/javascript' src="<%= Page.ResolveClientUrl("~/scripts/UIFlujo.js?ver=2")%>"></script>
    <script type='text/javascript' src="<%= Page.ResolveClientUrl("~/scripts/UIVal.js?ver=2") %>"></script>
</head>
