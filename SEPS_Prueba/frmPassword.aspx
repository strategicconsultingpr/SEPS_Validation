...
<asp:Content ID="mainEditC" runat="server" ContentPlaceHolderID="mainBodyContent">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h1 class="panel-title">Modificación de contraseña</h1>
        </div>
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-6 SEPSDivs"><span class="SEPSLabel">Modificación de contraseña:</span>
                ...
                <div class="col-md-6 SEPSDivs">
                    <asp:Button ID="btnPassword" runat="server" CssClass="btn btn-default" Text="Modificar contraseña" OnClick="btnPassword_Click"/>
                </div>
            </div>
